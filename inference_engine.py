...
try:
    ...
    torch.serialization.add_safe_globals([MLPVanilla, DenseVanillaBlock])
    print("--- PyTorch Safe Globals Registered ---")
except Exception as e:
    print(f"Warning: Could not register safe globals (might not be needed on older PyTorch): {e}")
# -------------------------------------
